...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <!-- this is the mark up code for the seating summary display -->
    <div class="col-md-7">
        <details open>
                    ...
                    <asp:TemplateField HeaderText="Reservation Notes / Seat Walk-In">
                        <ItemTemplate>
                            ...
                            <asp:Panel ID="OccupiedTablePanel" runat="server"
                                    Visible='<%# Item.Taken  %>'>
                                <asp:HyperLink ID="ServingTablesLink" runat="server" NavigateUrl='<%# string.Format("~/UXPages/ServingTables.aspx?waiter = {0}&bill={1}&md={2}&mt={3}&mds={4}&mts={5}",Item.Waiter,Item.BillID,Mocker.MockDate.Ticks,
                                Mocker.MockTime.Ticks,Mocker.MockDate.ToShortDateString(),Mocker.MockTime.ToString()) %>'>
                                <%# Item.Waiter %>
                                    </asp:HyperLink>
    ...
    <div class="pull-right col-md-5">
        ...
        <details open>
            ...
            <!--ItemType = parameters must be redirected to your current application locations. -->
            ...
            <!--Type Name = parameters must be redirected to your current application locations. -->
            <asp:ObjectDataSource runat="server" ID="ReservationsDataSource" OldValuesParameterFormatString="original_{0}" SelectMethod="ReservationsByTime" 
